...
{
    public class TestBackupMailContainerDataStore : IMailContainerDataStore
    {
        ...
        public TestBackupMailContainerDataStore(AllowedMailType type, int capacity, MailContainerStatus status)
        {
